...
alias gl="git log --graph --decorate --pretty=format:'%C(yellow)%h%Creset %s %C(green)%cr%Creset %C(blue)%an%Creset'"
alias gls="git log --graph --decorate --pretty=format:'%C(yellow)%h%Creset %s %C(green)%cr%Creset %C(blue)%an%Creset %n' --stat"
alias gp="git push"
alias gpl="git pull"
